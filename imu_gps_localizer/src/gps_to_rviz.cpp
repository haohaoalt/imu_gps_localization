/*
 * @Author: zhanghao
 * @Date: 2023-07-16 22:19:38
 * @LastEditTime: 2023-07-16 22:27:50
 * @FilePath: /eskf_ws/src/imu_gps_localization/imu_gps_localizer/src/gps_to_rviz.cpp
 * @Description: 
 */
#include <ros/ros.h>
...
int main(int argc,char **argv)
{
    ...
    ros::NodeHandle n;
    ros::Subscriber pose_sub = n.subscribe("/gps/fix", 20, gpsCallback);

    state_pub_ = n.advertise<nav_msgs::Path>("gps_path", 20);
